...
if cfg.sim == True:
    ...
    filename = "/net/storage03/data/users/rstein/tuples/qsq/MC_Bplus_Kplusmue_BDT.root"
    treename = "DecayTree"
else:
    ...
    filename = "/net/storage03/data/users/rstein/tuples/qsq/DATA_Bplus_Kplusmue_BDT.root"
    treename = "DecayTree"
...
t = f.Get(treename)
g = ROOT.TFile(filename[:filename.find(".root")] + "cut.root", "recreate")
