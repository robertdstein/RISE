...
def create_resamplers(options):
    ...
    pid_variables = ['{}_CombDLLK', '{}_CombDLLmu', '{}_CombDLLp', '{}_CombDLLe', '{}_newProbNNe', '{}_newProbNNK', '{}_V3ProbNNpi', '{}_newProbNNmu', '{}_V3ProbNNp']
    ...
    for sample in locations:
        ...
        for pid in pids:
            if "DLL" in pid:
                ...
                target_binning = np.linspace(-30, 30, 1000) # binning for ProbNN
            else:
                raise Exception
